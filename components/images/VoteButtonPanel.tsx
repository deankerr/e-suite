...
// import type { GeneratedImage, GenerationVoteNames } from '@/convex/external'
...
//   generatedImageId: Id<'generated_images'>
//   votes?: GeneratedImage['votes']
// }

// const ckey = crypto.randomUUID()

// export const VoteButtonPanel = ({ generatedImageId, votes }: VoteButtonPanelProps) => {
//   const [constituent] = useLocalStorage('e-constituent', ckey)
//   const myVote = useQuery(api.generated_images.getMyVote, { generationId, constituent })
