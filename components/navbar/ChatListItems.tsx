        ...
        {threads?.map(({ _id, title, parameters }) => (
          <NextLink
            ...
            className={cn(
              ...
              active(_id) ? 'bg-gray-2' : 'hover:bg-gray-2',
            )}
          >
            {/* icon */}
            <div className="flex shrink-0 flex-col justify-center px-4">
              <MessageSquareIcon
                className={cn('size-5 text-gray-11', active(_id) && 'text-gray-12')}
              />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Heading
                size="2"
                className={cn('truncate text-gray-11', active(_id) && 'text-gray-12')}
              >
                {title}
              </Heading>

              {/* model name */}
              <div className={cn('text-xs text-gray-10', active(_id) && 'text-gray-11')}>
