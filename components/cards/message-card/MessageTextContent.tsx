...
export const MessageTextContent = ({ content, className, ...props }: MessageTextContentProps) => {
  ...
  return (
    <div
      {...props}
      className={cn(
        'prose prose-stone prose-invert mx-auto min-h-6 max-w-none prose-h1:mb-2 prose-h1:text-lg prose-h2:mb-2 prose-h2:mt-1 prose-h2:text-lg prose-h3:mb-2 prose-h3:mt-1 prose-pre:p-0',
        className,
      )}
    >
      <Markdown
