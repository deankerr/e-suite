...
export const DemoSidebar = ({ props }: DemoSidebarProps) => {
  return (
    <aside
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span className="ml-3 flex-1 whitespace-nowrap text-left">Pages</span>
              <svg
                aria-hidden="true"
                className="h-6 w-6"
                fill="currentColor"
          ...
          <li>
            ...
            >
              ...
              <span className="ml-3 flex-1 whitespace-nowrap text-left">Sales</span>
              <svg
                aria-hidden="true"
                className="h-6 w-6"
                fill="currentColor"
          ...
          <li>
            ...
            >
              ...
              <span className="ml-3 flex-1 whitespace-nowrap text-left">Authentication</span>
              <svg
                aria-hidden="true"
                className="h-6 w-6"
                fill="currentColor"
