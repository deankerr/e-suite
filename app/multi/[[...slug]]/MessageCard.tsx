...
import { useRemoveMessage, useViewer } from '@/lib/api'
...
export const MessageCard = ({ slug = '', message, file, ...props }: MessageProps) => {
  ...
  const viewerIsOwner = viewer?._id === message.owner?._id
  ...
  return (
    <Card {...props}>
      <div className="space-y-3">
        <Inset side="top">
          <div className="h-8 gap-1 bg-gray-3 px-2 flex-between md:gap-2">
            {/* message type icon */}
