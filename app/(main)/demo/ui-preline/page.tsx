...
import { Page as SPage } from '@/components/Page'
...
export default function Page() {
  ...
  return (
    <SPage className="flex flex-col gap-4 p-6">
      <SPage.Main>
        <SPage.MainContent>
          <div>
            {/* palette test */}
              ...
              <div className="mt-3">
                ...
                >
                  <p className="text-gray-500 dark:text-gray-400">
                    This is the{' '}
                    <em className="font-semibold text-gray-800 dark:text-gray-200">first</em> item's
                    tab body.
                  </p>
                </div>
                <div
                ...
                >
                  <p className="text-gray-500 dark:text-gray-400">
                    This is the{' '}
                    <em className="font-semibold text-gray-800 dark:text-gray-200">second</em>{' '}
                    item's tab body.
                  </p>
                </div>
                <div
                ...
                >
                  <p className="text-gray-500 dark:text-gray-400">
                    This is the{' '}
                    <em className="font-semibold text-gray-800 dark:text-gray-200">third</em> item's
                    tab body.
                  </p>
                </div>
              </div>
