...
import { CivitaiModelDataJson } from '@/convex/image/civitai'
import { CivitaiModelData, ImageModel, ImageModelProvider } from '@/convex/schema'
...
export default function ImageModelsPage() {
  const imageModels = useQuery(api.imageModels.listWithProviders)
  return (
