...
// export const civitaiModelDataFields = {
//   civitaiId: v.string(),
//   updatedAt: v.number(),
...
//   await ctx.scheduler.runAfter(0, internal.providers.civitai.refresh, { id })
//   return id
// })
...
//   const record = await ctx.runQuery(internal.providers.civitai.get, { id })
...
//   await ctx.runMutation(internal.providers.civitai.update, {
//     doc: {
//       ...record,
